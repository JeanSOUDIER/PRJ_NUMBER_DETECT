...
std::vector<Movement> movement_0 = seqHandler.find('0').getMovements(); //Create a vector of movements
...
std::vector<Movement> movements_1 = seqHandler.find('1').getMovements();
