...
AboutWindow::AboutWindow(QWidget *parent) : QDialog(parent){
    ...
    QScrollArea *licenses_scroll = new QScrollArea(this);
        QGroupBox *licenses_box = new QGroupBox (licenses_scroll);
            ...
            //GNU_license_field->setMinimumWidth(licenses_scroll->width());
            ...
            //BSD_3_license_field->setMinimumWidth(licenses_scroll->width());
    ...
    setWindowTitle(tr("About Sequence Generator"));
    resize(w , h);
