...
int main(){
     ...
     for(unsigned int index = 0 ; index < movements_0.size() ; index++){
         ...
         const Movement nextMovement = *((index+1 < movements_0.size()) ? movements_0.at(index+1): nullptr); //Next one, put to nullptr if index is invalid
         ...
         /***************************************************************************/
         //Put the robot arm at the correct position during the correct time here.
         /****************************************************************************/
